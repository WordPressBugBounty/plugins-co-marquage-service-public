        ...
        ?>
            ...
            <div class="fiche-item fiche-slide">
                <div class="fiche-item-title">
                    <h2>
                        <button class="co-btn co-btn-slide" data-co-action="slide" type="button" data-co-target="#<?php echo esc_html($groupe['token']); ?>" role="button">
                ...
                <div class="fiche-item-content co-hide" id="<?php echo esc_html($groupe['token']); ?>">
                    <ul class="list-arrow">
                        <?php foreach ($groupe['children']['questionreponse'] as $questionreponse): ?>
                            <li><a href="<?php echo esc_url($internBaseURL.$questionreponse['attributes']['id']) ?>"><?php echo esc_html($questionreponse['text']) ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </div>
            </div>
