    ...
    <div class="fiche-item-content co-hide" id="<?php echo esc_html($token); ?>">
        <div class="panel-sat ">
            <ul class="list-arrow">
                ...
                <li>
                    <p class="panel-link">
                        <a href="<?php echo esc_url($reference['attributes']['url']); ?>" target="_blank">
                            <?php echo esc_html($reference['children']['titre'][0]['text']); ?>
                            <?php
                    ...
                    <p class="panel-comment"><?php echo esc_html($reference['children']['complement'][0]['text']); ?></p>
                    <?php endif; ?>
                </li>
                <?php } ?>
            </ul>
