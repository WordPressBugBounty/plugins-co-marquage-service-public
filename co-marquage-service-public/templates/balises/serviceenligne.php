    ...
    <div class="fiche-bloc fiche-slide service-in-root">
        <div class="fiche-item">
            <div class="fiche-item-title">
                <h3>
                    <button class="co-btn co-btn-slide" data-co-action="slide" data-co-target="#<?php echo esc_html($token); ?>" type="button">
        ...
        <div class="fiche-item-content co-hide" id="<?php echo esc_html($token); ?>">
            <div class="panel-sat">
                <ul class="list-arrow">
                    <?php
                    foreach($data as $service) {
                        ...
                        <li>
                            <p class="panel-link">
                                <a href="<?php echo esc_url($serviceURL); ?>" target="_blank">
                                    <?php echo esc_html($service['children']['titre'][0]['text']); ?>
                                </a>
                            </p>
                            <p class="panel-comment"><?php echo esc_html($service['attributes']['type']); ?></p>
                        </li>
                    <?php } ?>
                </ul>
            </div>
    ...
    <div class="service-in-content">
        ...
        if (isset($service_childs['titre'])):
            ...
            <div class="co-bloc-title">
                <?php if ($service['attributes']['type'] == 'Téléservice' || $service['attributes']['type'] == 'Téléservice personnalisé sur SP' ): ?>
                    ...
                    <p class="title-text">
                        Service en ligne<br/>
                        <strong><?php echo esc_html($service_childs['titre'][0]['text']) ?></strong>
                    </p>
                <?php else: ?>
                    <div class="title-icons">
                    ...
                    <p class="title-text">
                        <?php echo esc_html($service['attributes']['type']) ?> <br/>
                        <strong><?php echo esc_html($service_childs['titre'][0]['text']) ?></strong>
                    </p>
                <?php endif; ?>
            </div>
            <?php if (isset($service['attributes']['numerocerfa'])): ?>
                <p class="co-numerocerfa">Cerfa n° <?php echo esc_html($service['attributes']['numerocerfa']) ?> </p>
            <?php endif; ?>
            <?php
        endif;
        ...
        <div class="demarche-button">
            <?php if ($service['attributes']['type'] == 'Téléservice' || $service['attributes']['type'] == 'Téléservice personnalisé sur SP'): ?>
                ...
                <?php if (isset($service_childs['source'])) echo '<p class="service-source">'.esc_html($service_childs['source'][0]['text']).'</p>'?>
        ...
        <?php if(isset($service_childs['noticeliee'])): ?>
            ...
            <ul>
                ...
                foreach ($service_childs['noticeliee'] as $notice) :
                    ...
                    ?>
                    <li><a href="<?php echo esc_url($noticeURL); ?>" target="_blank"><?php echo esc_html($notice['text']); ?>&nbsp;<?php include(KIENSO_COMARQUAGE_DIR_ASSETS . "icons/external-link.svg"); ?></a></li>
                <?php endforeach; ?>
            </ul>
        <?php endif; ?>
        <?php if(isset($service_childs['serviceenligneannexe'])): ?>
            ...
            foreach ($service_childs['serviceenligneannexe'] as $annexe) :
                ...
                if (isset($annexe['attributes']['numerocerfa'])) echo '<p><b>Cerfa n°'.esc_html($annexe['attributes']['numerocerfa']).'</b></p>';

                $this->parse_not_children('texte', $annexe['children']['texte']);
                ?>
                <ul>
                    <li><a href="<?php echo esc_url($annexeURL); ?>" target="_blank"><?php echo esc_html($annexe['children']['titre'][0]['text']); ?>&nbsp;<?php include(KIENSO_COMARQUAGE_DIR_ASSETS . "icons/external-link.svg"); ?></a></li>
                </ul>
            <?php endforeach; ?>
        <?php endif; ?>
    </div>
